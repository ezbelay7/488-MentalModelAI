export const mentalModels = [
      ...
      models: [
        {
          ...
          description:
            "The map of reality is not reality. Even the best maps are imperfect. Thats because they are reductions of what they represent. If a map were to represent the territory with perfect fidelity, it would no longer be a reduction and thus would no longer be useful to us. A map can also be a snapshot of a point in time, representing something that no longer exists. This is important to keep in mind as we think through problems and make better decisions.",
    ...
    {
      group_name: "Physics and Chemistry",
      models: [
        {
          title: "Relativity",
          description:
    ...
    },
    {
      ...
      models: [
        ...
        {
          title: "10. Tendency to Minimize Energy Output (Mental and physical)",
          description:
    ...
    },
    {
      ...
      models: [
        ...
        {
          title: "11. Law of Diminishing Returns",
          description:
    ...
    },
    {
      ...
      models: [
        ...
        {
          title: "5. Regression to the Mean",
          description:
        ...
        {
          title: "9. Global and Local Maxima",
          description:
    ...
    {
      group_name: "Microeconomics",
      models: [
        {
          title: "1. Opportunity Costs",
          description:
        ...
        {
          title: "4. Specialization (Pin Factory)",
          description:
        ...
        {
          title: "6. Trademarks, Patents, and Copyrights",
          description:
        ...
        {
          title: "7. Double-Entry Bookkeeping",
          description:
        ...
        {
          title: "8. Utility (Marginal, Diminishing, Increasing)",
          description:
    ...
    {
      group_name: "Military and War",
      models: [
        {
          title: "1. Seeing the Front",
          description:
        ...
        {
          title: "5. Mutually Assured Destruction",
          description:
    ...
    {
      group_name: "Human Nature and Judgment",
      models: [
        {
          title: "1. Trust",
          description:
        ...
        {
          title: "4. Tendency to Feel Envy & Jealousy",
          description:
        ...
        {
          title: "7. Availability Heuristic",
          description:
        ...
        {
          title: "8. Representativeness Heuristic",
  ...
  c. Failure to See False Conjunctions�Most famously demonstrated by the Linda Test, the same two psychologists showed that students chose more vividly described individuals as more likely to fit into a predefined category than individuals with broader, more inclusive, but less vivid descriptions, even if the vivid example was a mere subset of the more inclusive set. These specific examples are seen as more representative of the category than those with the broader but vaguer descriptions, in violation of logic and probability.`,
        ...
        {
          title: "9. Social Proof (Safety in Numbers)",
          description:
        ...
        {
          title: "13. First-Conclusion Bias",
          description:
        ...
        {
          title: "14. Tendency to Overgeneralize from Small Samples",
          description:
        ...
        {
          title: "15. Relative Satisfaction/Misery Tendencies",
          description:
        ...
        {
          title: "16. Commitment & Consistency Bias",
          description:
        ...
        {
          title: "18. Sensitivity to Fairness",
          description:
        ...
        {
          title: "20. Influence of Stress (Including Breaking Points)",
          description:
        ...
        {
          title: "23. Falsification / Confirmation Bias",
